...
public class TestFuzzyQuery {
    ...
    public static void main(String[] args) {
       ...
       /* HttpPost post = new HttpPost(
        ...
        HttpPost post = new HttpPost(
                "http://10.74.12.121:8090/" + HttpSearchMethod.ADVQUERY);
...
//    		condMap.put(ConditionParser.KEY_DEVTYPE, "100");
           ...
           /* nameValuePairs.add(new BasicNameValuePair("startTime", "1510741200000"));
            ...
            nameValuePairs.add(new BasicNameValuePair("devAddr", "~10.33.222.2"));
...
//            nameValuePairs.add(new BasicNameValuePair("order", "desc"));
            ...
            nameValuePairs.add(new BasicNameValuePair("keyWords", "traffic"));
