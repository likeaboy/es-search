    ...
    public static void main(String[] args) {
       ...
       /* HttpPost post = new HttpPost(
        ...
        HttpGet get = new HttpGet(
                "http://10.74.12.121:8090/" + HttpSearchMethod.TEST);
       ...
       /* HttpPost post = new HttpPost(
        ...
        /* HttpPost post = new HttpPost(
        "http://10.95.30.50:8090/" + HttpSearchMethod.SIMQUERY);*/
...
//            get.setParams("startTime", "1511196360000");
//            get.setHeader("endTime", "1511279160000");
